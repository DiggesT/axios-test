...
export const postApiV1AuthLogin = (
    ...
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiV1AuthLogin>>, TError,{data: Login}, TContext>, }
) => {
...
export const useGetApiV1AuthWhoami = <TData = Awaited<ReturnType<typeof getApiV1AuthWhoami>>, TError = ErrorType<AuthError>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getApiV1AuthWhoami>>, TError, TData>, }
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiV1AuthWhoami>>> = ({ signal }) => getApiV1AuthWhoami(signal);
